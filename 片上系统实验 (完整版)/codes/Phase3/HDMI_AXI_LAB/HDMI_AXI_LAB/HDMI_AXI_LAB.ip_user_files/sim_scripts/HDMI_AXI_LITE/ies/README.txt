...
#
# Generated by export_simulation on Fri Jun 27 21:37:53 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './HDMI_AXI_LITE.sh' script.

./HDMI_AXI_LITE.sh -reset_run
...
./HDMI_AXI_LITE.sh -noclean_files

For more information on the script, please type './HDMI_AXI_LITE.sh -help'.
