...
#
# Generated by export_simulation on Fri Jul 04 22:36:53 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './bram_buffer.sh' script.

./bram_buffer.sh -reset_run
...
./bram_buffer.sh -noclean_files

For more information on the script, please type './bram_buffer.sh -help'.
