...
#set_property -dict {IOSTANDARD LVDS_25 DIFF_TERM 0} [get_ports {data_in_from_pins_n[0]}]
##set_property -dict {IOSTANDARD LVDS_25 DIFF_TERM 0} [get_ports {data_in_from_pins_n[1]}]

#set_property -dict {PACKAGE_PIN W6 IOSTANDARD LVDS_25 DIFF_TERM 0} [get_ports diff_clk_in_clk_p]
#set_property -dict {IOSTANDARD LVDS_25 DIFF_TERM 0} [get_ports diff_clk_in_clk_n]
